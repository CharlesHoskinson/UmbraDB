...
const TABLE: Row[] = [
  ...
  { instance: new MigrationLockTimeoutError("s", 10), code: "MIGRATION_LOCK_TIMEOUT", retryable: "non-retryable" },
...
describe("retryability is a machine-readable field on every StorageError (C5, C6)", () => {
  ...
  it("CONNECTION_ERROR, TRANSACTION_FAULT, LEASE_TIMEOUT are the retryable set (C2)", () => {
